...
def test_create_template():
    assert ComponentGenerator().create_template() == """<div class="pnc-container"><div id="component"></div></div>"""
    assert ComponentGenerator(children="name").create_template() == """<div class="pnc-container"><div id="component">${name}</div></div>"""
    assert ComponentGenerator(element="fast-button").create_template() == """<div class="pnc-container"><fast-button id="component"></fast-button></div>"""
    assert ComponentGenerator(class_name="test-class").create_template() == """<div class="pnc-container"><div id="component" class="test-class"></div></div>"""
    assert ComponentGenerator(tooltip_element="sl-tooltip").create_template() == """<div class="pnc-container"><sl-tooltip id="tooltip"><div id="component"></div></sl-tooltip></div>"""
...
def test_create_scripts_with_property():
    # When
    scripts = ComponentGenerator(tooltip_element="sl-button", tooltip_properties={"content": "tooltip"}).create_scripts()
    # Then
